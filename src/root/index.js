...
import { setCoordinates, setDeletedOrders, setOrders, setWeatherData } from '../redux/actions';
...
const Root = () => {
  ...
  const weatherCords = useSelector(({ utilsReducer }) => utilsReducer.coordinates);
